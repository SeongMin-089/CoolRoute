...
const flow = [
  { label: '센터 피킹 완료', caption: '출고 검수 완료', tone: 'ok' },
  { label: '차량 상차', caption: '냉장 구획 적재', tone: 'ok' },
  { label: '배송 중', caption: '현재 단계', tone: 'info' },
  { label: '점포 도착', caption: '12:30 예정', tone: 'warn' },
  { label: '입고 검수', caption: '도착 후 진행', tone: 'info' },
] as const
...
const alerts = [
  ...
  'DLV-1202는 상온 상품으로 온도 검수 대상이 아닙니다.',
  '도착 후 입고 확인 버튼으로 검수 상태를 변경할 수 있습니다.',
] as const
    ...
    <DashboardView role="store">
      <div className="dashboard-hero">
        <div className="dashboard-hero__copy">
          ...
          <h1>배송현황</h1>
          <p>점포 도착 예정 배송과 입고 검수 상태를 확인합니다.</p>
        </div>
      ...
      <section className="dashboard-panel">
        <div className="dashboard-panel__titlebar">
          <div>
            <span className="dashboard-panel__eyebrow">Delivery Flow</span>
            <h2>배송 진행 타임라인</h2>
            <p>현재 배송 단계는 배송 중이며 점포 도착 후 입고 검수가 이어집니다.</p>
          </div>
        </div>
      ...
      <div className="dashboard-grid">
        <section className="dashboard-panel dashboard-panel--wide">
          <div className="dashboard-panel__titlebar">
            <div>
              <span className="dashboard-panel__eyebrow">Delivery List</span>
              <h2>배송 목록</h2>
              <p>차량, 기사, 도착 예정 시간과 온도 상태를 함께 확인합니다.</p>
            </div>
          </div>
        ...
        <section className="dashboard-panel">
          <div className="dashboard-panel__titlebar">
            <div>
              <span className="dashboard-panel__eyebrow">Check</span>
              <h2>입고 체크리스트</h2>
              <p>배송 도착 시 점포 담당자가 확인할 항목입니다.</p>
            </div>
          </div>
